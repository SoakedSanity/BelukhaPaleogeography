...
4. Найти способ перевода единиц измерений для представления данных на одном рисунке без использования вспомогательных осей.
5. Написать функцию по сглаживанию графика при помощи метода скользящего среднего для увеличения читаемости итогового рисунка.
6. Наложить графики на один рисунок.
